...
| `story-to-manga` | 怪談・体験談・一次資料・説明文などを、原文の確度を保った漫画へ変換し、画像生成まで実行 | `$story-to-manga この怪談を8ページの漫画にして` | 原文・メモ・根拠のある要約。任意でページ数、形式、画風方向、人物資料、希望する停止段階 | 適応方針、出典整理、ネーム、キャラ/背景基準画、生成指示、ページ/コマ画像、文字入れ表、QA結果 |
